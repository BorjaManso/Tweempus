...
export class TwimpListComponent implements OnInit {  
  ...
  ngOnInit() {
    ...
    this.twimps.push(new Twimp('2', '', this.authors[0], this.text, '02/01/2000'));
    this.twimps.push(new Twimp('3', '', this.authors[0], this.text, '03/01/2000'));
    this.twimps.push(new Twimp('4', '', this.authors[0], this.text, '04/01/2000'));
  }
} 
